...
function lancementQCM() {
    if (listeNombresInterdits.length === 96) {
        ...
        nombreAuPif = nombreAuPifSansInterdit(listeTemporaire.length, listeNombresInterdits);
        ...
        for (let i = 0; i < optionDepartement.length; i++) {
            let nombreInjectionHasard = getRandomInt(listePropositionDepartement.length);
        ...
        for (let i = 0; i < optionPrefecture.length; i++) {
            let nombreInjectionHasard = getRandomInt(listePropositionPrefecture.length);
...
function verifChoixJoueurQCM() {
    ...
    if (paireDepartementTrouvee === false ||
